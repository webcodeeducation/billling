...
<img src="images/Soil_health_logo.png" class="img-responsive innerlogo" width="100">
<h1 style="color:white">Kunal Associate Billing System</h1> 
</div>
  ...
  <div class="col-md-7">
    <div class="row menus">
    <div class="col-md-4">
        <a href="insert_category.php"><div class="panel">Add Category</div></a>   
      </div>
    <div class="col-md-4">
      ...
      <div class="col-md-4">
      <a href="mastersetting.php"><div class="panel">Master Settings</div></a>   
      </div>
    </div>
  </div>
