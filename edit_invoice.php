	    	...
	    	<div class="load-animate animated fadeInUp">
		    	...
		    	<div class="row">
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		      			<?php //print_r($invoiceValues); $billno = $invoiceValues['bill_no']; echo $billno; ?>
		      			<h3>From,</h3>
		      		...
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
		      			...
		      			<div class="form-group">
							<input value="<?=$invoiceValues['order_date']?>" type="text" class="form-control" name="billdate" id="datepicker" placeholder="Bill Date">
						</div>
						<h3>Bill No</h3>
		      			<div class="form-group">
							<input type="text" class="form-control" name="billno" id="billno" value="<?=$invoiceValues['bill_no']?>" placeholder="Bill No">
						</div>
						<h3>To,</h3>
		      			<div class="form-group">
		      		...
		      		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		      			<table class="table table-bordered table-hover" id="invoiceItem">	
							...
							<tr>
								...
								<td><input type="text" value="<?php echo $invoiceItem["order_item_hsn"]; ?>" name="order_item_hsn[]" id="hsn_<?php echo $count; ?>" class="form-control hsn" autocomplete="off"></td>
		      		...
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
						<span class="form-inline">
							...
							<div class="form-group">
								<label>CGST: &nbsp;</label>
								<div class="input-group">
									<input value="<?php echo $settings['cgst']; ?>" type="number" class="form-control" name="cgst" id="taxRate" placeholder="Tax Rate">
									<div class="input-group-addon">%</div>
								</div>
							</div>
							<div class="form-group">
								<label>SGST: &nbsp;</label>
								<div class="input-group">
									<input value="<?php echo $settings['sgst']; ?>" type="number" class="form-control" name="sgst" id="taxRate2" placeholder="Tax Rate">
									<div class="input-group-addon">%</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-addon currency">$</div>
									<input value="<?php echo floor($invoiceValues['order_total_after_tax']); ?>" type="number" class="form-control" name="totalAftertax" id="totalAftertax" placeholder="Total">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-addon currency">$</div>
									<input value="<?php echo floor($invoiceValues['order_total_amount_due']); ?>" type="number" class="form-control" name="amountDue" id="amountDue" placeholder="Amount Due">
								</div>
							</div>
						</span>
					</div>
