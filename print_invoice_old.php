...
<tr>
	<td width="20%" align="center" style="font-size:18px"><img src="./images/logo2.jpg" width="100px" widt></td>
	<td width="40%" align="left" style="font-size:24px"><b>Kunal Associate</b><br> <span style="font-size:15px" > Kalal Majra, Near Hanuman Mandir, Thaanesar<br>, Kurukshetra<br>PAN: 1234567890</span></td>
...
$output .= '
	...
	<tr>
	<td align="right" colspan="5">Taxable Amount: </td>
