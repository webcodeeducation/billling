...
if(isset($_POST['item_btn'])) {
  $invoice -> insertCategories($_POST);
  $success = true;
		...
		<div class="load-animate animated fadeInUp">
			<div class="row">
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<h2 class="title">Insert New Category</h2>	
				</div>		    		
			</div></br></br>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<table class="table table-bordered table-hover" id="insertItem" >	
						<tr>
							...
							<th width="48%">Category Name</th>
						</tr>							
						<tr>
							<td><input class="itemRow" type="checkbox"></td>
							
							<td><input type="text" name="categoryName[]" id="categoryName_1" class="form-control" autocomplete="off"></td>			
						</tr>						
					</table>
			</div>
      </div>
